...
export const ERROR_MESSAGES = {
  ...
  TIME_START_IS_EMPTY:
    'Failed to create event. Please provide the start time of event.',
  TIME_END_IS_EMPTY:
    'Failed to create event. Please provide the end time of event',
  ...
  TIME_END_IS_BEFORE_TIME_START:
    'Failed to create event. The event must not end before the start time',
